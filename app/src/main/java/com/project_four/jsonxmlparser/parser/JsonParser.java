...
import com.project_four.jsonxmlparser.utils.Helper;
...
public class JsonParser {
    ...
    public List<Country> jsonParser(String json_string){
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++){
                ...
                country.setCoed(jsonObject.getString("code"));
    ...
    public CountryForGSONLibrary jsonParserUsingGSON(Context context){
